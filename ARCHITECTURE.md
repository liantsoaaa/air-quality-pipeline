...
- fichiers de backfill (une liste de ~700 mesures par fichier)

Les deux formats sont uniformisés en un seul DataFrame avant nettoyage.

**Nettoyage**, avec le vocabulaire vu en cours :
...
Le workflow exécute désormais deux étapes à chaque déclenchement : extraction, puis transformation.
